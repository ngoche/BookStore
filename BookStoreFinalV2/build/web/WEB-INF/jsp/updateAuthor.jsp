...
<html>
    ...
    <body>
        ...
        <div class="container">
            <center>
                <h1>UPDATE Author</h1>
                <spring:form action="updateAuthor.htm" commandName="author" class="form-horizontal">
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="email">Author Id:</label>
                        <div class="col-sm-4">
                            <spring:hidden path="id" class="form-control"/>
                            <input type="id" class="form-control" value="${author.id}" disabled="true">
                        </div>
                    </div>
