...
<html>
    ...
    <body>
        ...
        <div class="container">
            <center>
                <h1>UPDATE BOOK</h1>
                <spring:form action="updateCate.htm" commandName="cate" class="form-horizontal">
                    <div class="form-group">
                        <label class="control-label col-sm-4" for="email">Category Id:</label>
                        <div class="col-sm-4">
                            <spring:hidden path="id" class="form-control"/>
                            <input type="id" class="form-control" value="${cate.id}" disabled="true">
                        </div>
                    </div>
