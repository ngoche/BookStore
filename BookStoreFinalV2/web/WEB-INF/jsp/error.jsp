<%-- 
    Document   : error
    Created on : Jun 20, 2018, 10:43:00 PM
    Author     : DuongNguyen
--%>
...
<html>
    ...
    <body>
        <div class="main">
            ...
            <h1 style="color: #676767">404</h1>
            <h2 style="color: #676767">ooops, something goes wrong</h2>
            <div class="more_w3ls">
                <a href="welcomeTest.htm">Try Once Again</a>
            </div>
