    ...
    <body>
        <jsp:include page="tHeader.jsp"></jsp:include>
            <div class="container">
                ...
                <spring:form action="loginDoneT.htm" commandName="acclogin" method="post">
                    <table>
                            <tr>
                                <td><h3>${status}</h3></td>
                        </tr>
                        ...
                        <tr>
                            <td><h3 style="color: orangered">${loginErr}</h3></td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <input type="submit" value="Login"/>
                                <span style="margin-left: 20px">  To create the new account, click <a href="initRegisterT.htm" style="font-weight: bold;font-size:30px">here</a></span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <span style="margin-left: 20px"></a></b></span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
