    ...
    <body>
        ...
        <div class="col-md-2">
            <div class="panel panel-primary" style="margin-top: 45px">
                ...
                <div class="list-group">
                    <span href="#" class="list-group-item active panel-heading">Publisher Management </span>
                    <a href="initInsertPublisher.htm" class="list-group-item ">Add New Publisher</a>
        ...
        <div class="col-md-10  panel panel-default" style="margin-top: 30px">
            ...
            <table class="table">
                ...
                <tbody>
                    <c:forEach items="${listPublisher}" var="a" >
                        <tr>
                            <td>${a.id}</td>
                            <td>${a.name}</td>
                            <td>${a.address}</td>
                            ...
                            <td><a href="preUpdatePublisher.htm?id=${a.id}" class="btn btn-info btn-sm">Update</a></td>
                            <td><a href="deletePublisher.htm?id=${a.id}" class="btn btn-danger btn-sm" onclick="return alert('Are You Sure?')">Delete</a></td>
                        </tr>
                    </c:forEach>
